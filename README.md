...
For non-interpretable classifiers, we have brought the result from the most recent benchmark in (https://link.springer.com/article/10.1007/s10994-021-06057-9)[HIVE-COTE 2.0] paper.